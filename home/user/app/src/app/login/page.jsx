      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <motion.p
            ...
            className="mt-4 text-zinc-400 max-w-md"
          >
            Sign in to your account to manage tasks, collaborate with your team, and track progress.
          </motion.p>
        </div>
        ...
        <FadeIn className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <GlowButton
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 py-3 text-sm font-semibold text-white disabled:opacity-50"
            >
